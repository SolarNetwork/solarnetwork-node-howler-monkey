 ...
 *
 * <p>
 * It understands the 4-byte frame produced by
 * {@code Atm90E36.readRegister} / {@code Atm90E36.writeRegister}: a 16-bit
 * big-endian register address (with bit 15 set for reads) followed by a 16-bit
 * big-endian value. Reads are answered from {@link #registers}; writes are
 * recorded in {@link #writes}.
 * </p>
 */
