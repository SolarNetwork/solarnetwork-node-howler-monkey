 ...
 *
 * <p>
 * Unchecked so that the {@link Atm90E36} accessor methods can propagate low
 * level errors without every getter declaring a checked exception, matching the
 * behaviour of the original Python {@code meter-tool} program.
 * </p>
 *
 * @author matt
 * @version 1.0
